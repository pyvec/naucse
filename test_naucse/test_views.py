...
@pytest.mark.parametrize(
    ...
    [
        ('/', 'Kurzy nalezené'),
        ('/+default/', 'top-level course'),
        ('/+default/sessions/test-session/', 'Test lesson'),
        ('/+default/test/test/', 'Main page'),
        ('/+default/test/test/sub/', 'Subpage'),
        ('/+default/test/test/static/circle.svg', '</svg>'),
